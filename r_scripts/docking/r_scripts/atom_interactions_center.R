...
for (i in 1:nrow(df_merge)) {
  ...
  ligand_name<-paste0(part_name,"str_fin_center/",df_merge$name.x[i])
  ...
  print(paste0(df_merge$name.x[i]," ", paste0(df_interaction$resno.x[df_interaction$resno.x%in%c(86:114,234:275)],collapse=" ")))
