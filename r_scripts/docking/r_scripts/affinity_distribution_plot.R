...
p_table<-p+annotate(geom = "table",
                  ...
                  label = list(pwc2))
#pwc2
ggsave(p,file="density_ligand_affility_antibiotics.png", width = 24, height = 15, units = c("cm"), dpi = 200 )
...
p_table<-p+annotate(geom = "table",
                    ...
                    label = list(pwc2))
#pwc2
ggsave(p,file="density_ligand_affility_lipids.png", width = 24, height = 15, units = c("cm"), dpi = 200 )